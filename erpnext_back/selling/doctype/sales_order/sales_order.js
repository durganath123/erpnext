		...
		if (doc.docstatus==1) {
			...
			if(doc.status !== 'Closed') {
				if(doc.status !== 'On Hold') {
					...
					// delivery note
					if(flt(doc.per_completed, 6) < 100 && ["Sales", "Shopping Cart"].indexOf(doc.order_type)!==-1 && allow_delivery) {
