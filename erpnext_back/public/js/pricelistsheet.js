...
$("#qtyTable tbody").scroll(function(e) {
		$("#qtyTable thead").css("left", -$("#qtyTable tbody").scrollLeft());  
		$("#qtyTable thead th:nth-child(1)").css("left", $("#qtyTable tbody").scrollLeft());  
		$("#qtyTable tbody td:nth-child(1)").css("left", $("#qtyTable tbody").scrollLeft());   
	});
});
...
$("#qtyTable tbody").scroll(function(e) {
	...
	$('#qtyTable tbody').on('keydown','td', function(e) {
		if (e.keyCode == 9) {
			
			var this_val = parseFloat($(this).html());
			var title_val = parseFloat($(this).attr("title"));
			
			if(isNaN(this_val) && !isNaN(title_val))
			{
				$(this).html(title_val);
			}
			if(!isNaN(this_val))
			{
				$(this).attr("title",this_val)
			}
